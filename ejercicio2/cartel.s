...
//-----------------------------CARTEL--------------------------------------
    cartel:
            mov x25, lr                 //Guardo lr(posicion de retorno) en x25
    ...
    //-------------------------LETRAS--------------------------------------
            ...
            mov lr, x25                     //restauro lr
     br lr                                  //retorno a la rutina que llamo

//-------------------------------CIRCULOS------------------------------------------
    
    //---------------------------GRUPO 1-------------------------------------------
        circulosg1:
                mov x22, lr                 //guardo lr (posicion de retorno) en x22
